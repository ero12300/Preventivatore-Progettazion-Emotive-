...
const Home: React.FC<HomeProps> = ({ setView }) => {
  return (
    <div className="animate-reveal">
      {/* Hero Section */}
      <section className="relative min-h-[95vh] bg-brand-dark flex items-center pt-24 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 py-32">
          <div className="max-w-5xl space-y-12">
            <div className="inline-flex items-center gap-6 text-brand-gold">
              <span className="w-16 h-[1px] bg-brand-gold/60"></span>
              <span className="text-[10px] font-black uppercase tracking-[0.6em]">Protocollo Emotive</span>
            </div>
            
            <h1 className="text-6xl md:text-9xl font-black leading-[0.85] text-white serif tracking-tighter">
              Dall'Ansia <br/>
              <span className="italic text-brand-gold">all'Asset.</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-white/95 max-w-2xl leading-relaxed font-light italic">
            ...
            <div className="pt-10">
              <button 
                ...
                className="btn-emotive-primary !px-16 !py-8 !text-xs !shadow-2xl hover:scale-105 active:scale-95 transition-transform"
              >
                Crea Preventivo
              </button>
            </div>
      ...
      <section className="py-40 bg-[#050505] text-white px-6 overflow-hidden relative">
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              <div className="space-y-6">
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-brand-gold">Perché scegliere Emotive</span>
                <h2 className="text-5xl md:text-7xl font-bold serif italic leading-[1.1] tracking-tight">
              ...
              <div className="space-y-8 text-gray-400 text-lg font-light leading-relaxed italic">
                <p>
      ...
      <section className="py-40 bg-white px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-16">
            <div className="space-y-8 p-12 bg-[#fdfdfd] border border-gray-100 hover:shadow-2xl transition-all duration-500">
              <div className="w-12 h-12 bg-brand-dark text-brand-gold flex items-center justify-center font-black text-xs">01</div>
              <h3 className="text-2xl font-black uppercase tracking-tighter">Analisi Sistemica</h3>
            ...
            <div className="space-y-8 p-12 bg-[#fdfdfd] border border-gray-100 hover:shadow-2xl transition-all duration-500">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tighter">Produzione Diretta</h3>
              <p className="text-gray-500 font-light leading-relaxed">
            ...
            <div className="space-y-8 p-12 bg-[#fdfdfd] border border-gray-100 hover:shadow-2xl transition-all duration-500">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tighter">Workflow Digitale</h3>
              <p className="text-gray-500 font-light leading-relaxed">
      ...
      {/* Final CTA Area */}
      <section className="py-48 bg-[#050505] text-center px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-16 relative z-10">
          <h2 className="text-5xl md:text-8xl font-black serif italic text-white leading-none tracking-tighter">
            Smetti di sperare. <br/> <span className="text-brand-gold">Inizia a misurare.</span>
          </h2>
          <p className="text-gray-400 text-xl md:text-2xl font-light max-w-2xl mx-auto leading-relaxed italic">
          ...
          <div className="flex flex-col items-center gap-6">
            <button 
              onClick={() => setView(AppView.CREATE_QUOTE)}
              className="btn-emotive-primary !px-20 !py-10 !text-xs shadow-2xl"
            >
              Crea il tuo Preventivo
            </button>
            <p className="text-[9px] font-black uppercase tracking-[0.5em] text-gray-500 italic">Protocollo E.M.O.T.I.V.E.® — Eros Boncordo Lead Strategist</p>
          </div>
        </div>
      </section>
    </div>
